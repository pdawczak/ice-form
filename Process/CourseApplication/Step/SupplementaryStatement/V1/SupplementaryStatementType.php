...
class SupplementaryStatementType implements FormTypeInterface
{
    /**
    ...
    {
        $builder->add('supplementaryStatement', 'textarea', [
            'label' => 'Please detail any further relevant information in support of your application, if you wish to do so.',
            'required' => false
        ]);
    }
    ...
    public function configureOptions(FormOptionsConfigurationInterface $optionConfiguration)
    {
        ...
        $optionConfiguration->setDefaults([
            'data_class'=>'Ice\FormBundle\Process\CourseApplication\Step\SupplementaryStatement\V1\SupplementaryStatementData'
        ]);
    }
