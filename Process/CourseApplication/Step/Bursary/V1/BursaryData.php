...
class BursaryData
{
    ...
    /**
     * @param mixed $previousICEStudy
     * @return BursaryData
     */
    public function setPreviousICEStudy($previousICEStudy)
    {
        $this->previousICEStudy = $previousICEStudy;
        return $this;
    }
     ...
     * @return mixed
     */
    public function getPreviousICEStudy()
    {
        return $this->previousICEStudy;
    }
