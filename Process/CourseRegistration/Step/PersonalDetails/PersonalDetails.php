...
class PersonalDetails{
    ...
    /** @var \DateTime
     *  @Assert\Date(groups={"new_user", "require_dob"}, message="Please provide your date of birth")
     *  @Assert\NotBlank(groups={"new_user", "require_dob"}, message="Please provide your date of birth")
     */
    private $dob;
