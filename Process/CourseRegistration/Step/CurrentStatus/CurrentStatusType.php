...
class CurrentStatusType extends AbstractRegistrationStep
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('position', 'text', array('label' => 'Position', 'required'=>false))
    ...
    public function prepare()
    {
        if ($this->getStepProgress()->getUpdated()) {
            $contact = CurrentStatus::fromStepProgress($this->getStepProgress());
        } else {
            $contact = new CurrentStatus();
        }
    ...
    {
        return 'CurrentStatus.html.twig';
    }

    public function getJavaScriptTemplate(){
        return 'CurrentStatus.js.twig';
    }
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        ...
        $resolver->setDefaults(array(
            'validation_groups' => function(FormInterface $form) {
                ...
                if($data->getCurrentStatus() === 'Professional'){
                    $groups[] = 'status_professional';
                }
