...
class MakePaymentType extends AbstractType
{
     ...
     * @return string
     */
    private function countryAlpha3ToAlpha2($code)
    {
        $countries = array(
            ...
            array( 'alpha2' => 'AX', 'name' => 'Ã…land Islands', 'alpha3' => 'ALA', 'numeric' => '248' ),
            ...
            array( 'alpha2' => 'BL', 'name' => 'Saint BarthÃ©lemy', 'alpha3' => 'BLM', 'numeric' => '652' ),
    ...
    public function render(array $vars = array())
    {
        ...
        $vars['iframeUrl'] = $this->request->getIframeUrl(array(
                ...
                'billingstreet'=>implode(', ', array_filter(
                    array($customer->getAddress2(), $customer->getAddress3(), $customer->getAddress4()))),
                'billingtown'=>$customer->getTown(),
                'billingpostcode'=>$customer->getPostcode(),
                'billingcounty'=>$customer->getCounty(),
                'billingcountryiso2a'=>$this->countryAlpha3ToAlpha2($customer->getCountry()),
